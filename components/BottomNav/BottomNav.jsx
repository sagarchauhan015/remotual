...
export default function BottomNav(props) {
  return (
    <>
        <div className=''>
            <Link href="/">
                <div className='lg:static lg:rounded-[8px] lg:px-[23px] lg:py-[16px] lg:mb-4 lg:shadow-none cursor-pointer w-[fit-content] z-50 font-semibold fixed left-0 bottom-0 bg-white rounded-[0px_8px_0_0] text-center px-5 py-[12px] shadow-[5px_-5px_4px_0px_rgba(0,0,0,0.04)] flex flex-col justify-center items-center'>
            ...
            <div className='lg:static lg:rounded-[8px] lg:shadow-none lg:w-fit lg:block flex w-[fit-content] z-50 fixed bottom-0 right-0 bg-white rounded-[8px_0_0_0] text-center  shadow-[-5px_-5px_4px_0px_rgba(0,0,0,0.04)]'>
                ...
                <div onClick={() => props.handleTabName('profile')}  className='lg:px-[12px] lg:py-[14px] px-5 py-[12px] font-semibold cursor-pointer flex flex-col justify-center items-center'>
                ...
                <div onClick={() => props.handleTabName('resume')} className='lg:px-[12px] lg:py-[14px] px-5 py-[12px] font-semibold cursor-pointer flex flex-col justify-center items-center'>
                ...
                <div onClick={() => props.handleTabName('feedback')} className='lg:px-[12px] lg:py-[14px] px-5 py-[12px] font-semibold cursor-pointer flex flex-col justify-center items-center'>
                ...
                <div onClick={() => props.handleTabName('playlist')} className='lg:px-[12px] lg:py-[14px] px-5 py-[12px] font-semibold cursor-pointer flex flex-col justify-center items-center'>
